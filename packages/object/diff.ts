const diff = (
  obj1: object | Array<any>,
  obj2: object | Array<any>,
  pathConverter
) => {
  ...
  const pushReplace = (path, basePath, key, diffs, pathConverter, obj2) => {
  ...
  const getDiff = (obj1, obj2, basePath, diffs) => {
...
const jsonPatchPathConverter = (arrayPath) => {
